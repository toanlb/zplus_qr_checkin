                        ...
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                    ...
                                    <div>{{ __('Quản lý gói thành viên') }}</div>
                                    <div class="ms-1">
                                        <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                        </svg>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('memberships.index')">
                                    {{ __('Danh sách gói thành viên') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('memberships.create')">
                                    {{ __('Thêm gói thành viên mới') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('memberships.expiring')">
                        ...
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('check-ins.index')">
                                    {{ __('Quét mã QR Check-in') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('check-ins.today')">
                                    {{ __('Check-in hôm nay') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('check-ins.create')">
                                    {{ __('Tạo check-in thủ công') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
