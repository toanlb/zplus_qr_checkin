...
<html>
<head>
    <title>Thông báo: Thành viên của bạn sắp hết hạn</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="content">
        ...
        <p>Chúng tôi gửi email này để thông báo rằng thành viên của bạn tại Câu Lạc Bộ Thể Dục sẽ hết hạn sau <strong>{{ $daysLeft }} ngày</strong>.</p>
        ...
        <p>Để tiếp tục sử dụng dịch vụ và các tiện ích của Câu Lạc Bộ, vui lòng gia hạn thành viên của bạn trước ngày hết hạn.</p>
        
        <p>Bạn có thể gia hạn trực tiếp tại Câu Lạc Bộ hoặc qua hệ thống online của chúng tôi.</p>
        
        <a href="{{ url('/dashboard') }}" class="button">Đăng nhập vào hệ thống</a>
